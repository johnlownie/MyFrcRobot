...
/**
 * PathPlanner auto builder that handles running default commands while driving a path.
 */
public class AutoBuilder extends SwerveAutoBuilder {
     ...
     * 
     */
    public AutoBuilder( Supplier<Pose2d> poseSupplier, Consumer<Pose2d> resetPose, SwerveDriveKinematics kinematics,
            PIDConstants translationConstants, PIDConstants rotationConstants, Consumer<SwerveModuleState[]> outputModuleStates,
            Map<String, Command> eventMap, boolean useAllianceColor, Command[] commandsDuringPath, Subsystem... driveRequirements) {
